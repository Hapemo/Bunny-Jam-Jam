...
class Bunny_CarrotCollectionScript : public ScriptComponent {
private:
	std::string name{ "Bunny_CarrotCollectionScript" };
	Scene* currScene;
...
public:
	...
	Default constructor
	*******************************************************************************/
	Bunny_CarrotCollectionScript() = default;
	/*!*****************************************************************************
	\brief
	Default destructor.
	*******************************************************************************/
	~Bunny_CarrotCollectionScript() override = default;
