...
class BunnyChef_PlayerMovement : public ScriptComponent {
private:
	std::string name{ "BunnyChef_PlayerMovement" };
	Scene* currScene;
...
public:
	...
	Default constructor
	*******************************************************************************/
	BunnyChef_PlayerMovement() = default;
	/*!*****************************************************************************
	\brief
	Default destructor.
	*******************************************************************************/
	~BunnyChef_PlayerMovement() override = default;
